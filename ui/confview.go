...
import (
	...
	"github.com/hzcrv1911/frpcgui/pkg/layout"
		...
		Children: []Widget{
			TableView{
				...
				Columns: []TableViewColumn{
					{Title: i18n.Sprintf("Name"), Width: 130},
					{Title: i18n.Sprintf("Server Address"), Width: 120},
					{Title: i18n.Sprintf("Port"), Width: 50},
				},
				Model:          cv.model,
				MultiSelection: true,
				...
				StyleCell: func(style *walk.CellStyle) {
					...
					// Only show icon in the first column
					if style.Col() != 0 {
						return
					}
...
func (cv *ConfView) fixWidthToToolbarWidth() {
	...
	minWidth := cv.listView.IntFrom96DPI(320)
	width := max(toolbarWidth, minWidth)
	cv.SetMinMaxSizePixels(walk.Size{Width: width}, walk.Size{Width: width})
}
